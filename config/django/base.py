"""
Django settings for spares_tracker project.
...
LOCAL_APPS = [
    'spares_tracker.core.apps.CoreConfig',
    'spares_tracker.common.apps.CommonConfig',
    'spares_tracker.tasks.apps.TasksConfig',
    'spares_tracker.api.apps.ApiConfig',
    'spares_tracker.users.apps.UsersConfig',
    'spares_tracker.errors.apps.ErrorsConfig',
    'spares_tracker.testing_examples.apps.TestingExamplesConfig',
    ...
    'spares_tracker.spareparts.apps.RepairsConfig'
]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///spares_tracker'),
}
