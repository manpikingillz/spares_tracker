...
from spares_tracker.utils.tests import faker

from spares_tracker.testing_examples.services import student_create
from spares_tracker.testing_examples.tests.factories import SchoolFactory, SchoolCourseFactory


class StudentCreateTests(TestCase):
    @patch('spares_tracker.testing_examples.services.students.school_list_school_courses')
    @patch('spares_tracker.testing_examples.services.students.roster_create')
