...
from spares_tracker.core.exceptions import ApplicationError

from spares_tracker.common.services import model_update

from spares_tracker.emails.models import Email
from spares_tracker.emails.tasks import email_send as email_send_task
...
def email_send(email: Email) -> Email:
    ...
    from_email = "gtwesigomwe1@gmail.com"
    to = email.to
