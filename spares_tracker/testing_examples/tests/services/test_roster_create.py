...
from spares_tracker.testing_examples.tests.factories import (
    StudentFactory,
    SchoolCourseFactory
)

from spares_tracker.testing_examples.models import Roster
from spares_tracker.testing_examples.services import (
    roster_create,
...
class RosterCreateTests(TestCase):
    ...
    @patch('spares_tracker.testing_examples.services.rosters.roster_validate_period')
